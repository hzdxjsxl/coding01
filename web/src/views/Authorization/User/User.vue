...
import { delUserApi, getListApi, saveUserApi, updateUserApi } from '@/api/user'
...
const fetchDepartment = async () => {
  const res = await getDeptListPage()
...
const delData = async (row?: DepartmentUserItem) => {
  ...
  await delUserApi(unref(ids.value)).finally(() => {
...
const save = async () => {
  ...
  if (formData) {
    ...
    try {
      const apiMethod = actionType.value === 'edit' ? updateUserApi : saveUserApi
